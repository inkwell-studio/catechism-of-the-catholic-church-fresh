import ContentMap from '../catechism/artifacts/renderable-path-id_to_content.json' assert { type: 'json' };
import { PathIdContentMap } from '../catechism/source/types/types.ts';
...
export function getContent(pathID: PathID): ContentContainer {
    return (ContentMap as PathIdContentMap)[pathID];
}
